...
class SkillCategoryForm
{
            ...
            ->components([
                Section::make()
                    ->schema([
                        ...
                        Select::make('icon')
                            ->label('Icône (Heroicon Outline)')
                            ->options(self::heroiconOptions())
                            ->searchable()
                            ->placeholder('Choisissez une icône')
                            ->helperText('Recherchez par nom (ex: server, code-bracket).'),
    ...
    public static function heroiconOptions(): array
    {
        ...
        // Création du tableau d'options : la clé est l'icône telle qu'utilisée dans les vues Blade,
        // la valeur est le nom lisible (pascal case à partir du nom)
        return array_combine(
            array_map(fn ($icon) => "heroicon-o-{$icon}", $icons),
            array_map(fn ($icon) => Str::title(str_replace('-', ' ', $icon)), $icons)
        );
    }
}
