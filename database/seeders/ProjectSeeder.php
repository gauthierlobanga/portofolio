...
class ProjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($tags as $name) {
            // Générer le slug en français
            $slug = Str::slug($name);

            // Encoder en JSON pour la colonne JSON
        ...
        $slug1 = Str::slug('Renforcement des capacités et relèvement communautaire post-conflit');
        ...
        $slug2 = Str::slug('Appui à l’entrepreneuriat solidaire des femmes, ex-combattants et jeunes désœuvrés');
        ...
        $slug3 = Str::slug('Réduction des violences communautaires pour la paix et la cohésion sociale');
        ...
        $slug4 = Str::slug('Sécurité alimentaire et renforcement des ménages agricoles PAM/FAO');
        ...
        $slug5 = Str::slug('Assistance alimentaire et résilience des communautés du Sud-Ubangi et du Tanganyika');
        ...
        $slug6 = Str::slug('Chaînes de valeur agricoles résilientes au Kasaï Central');
        ...
        $slug7 = Str::slug('Relance des activités de sécurité alimentaire et de cohésion sociale au Nord-Kivu');
        ...
        $slug8 = Str::slug('Agroécologie paysanne et conservation des écosystèmes');
        ...
        $slug9 = Str::slug('Sécurisation foncière et gouvernance des terres rurales');
        ...
        $slug10 = Str::slug('Éducation de qualité et insertion professionnelle des jeunes ruraux');
