<x-layouts::app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
            <div x-data data-button-pulse class="rounded-full bg-honey-200" aria-label="Submit your plugin to Filament"
                x-init="async () => {
                ...
                <a href="https://filamentphp.com/author" target="_blank" rel="noopener noreferrer"
                    ...
                    <div data-icon
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.25" style="transform: rotate(0deg)"
