...
<div class="bg-white text-zinc-700 antialiased dark:bg-zinc-950 dark:text-zinc-300">
        ...
        <div class="flex flex-col lg:flex-row lg:min-h-[50svh] max-w-7xl mx-auto">
            ...
            <div
                ...
                <div class="w-full max-w-2xl">
                    ...
                    {{-- Boutons CTA modernes – Thème Emerald / Slate --}}
                    <div x-ref="buttons" class="mt-5 flex flex-col sm:flex-row items-center gap-5">
                        {{-- Bouton Découvrir mes projets --}}
                        ...
                        <div x-data="buttonAnimation"
                            class="rounded-full border-2 border-slate-300 bg-white/80 dark:border-slate-600 dark:bg-zinc-900/80 shadow-sm hover:border-emerald-400 dark:hover:border-emerald-600 transition-colors">
                            <a href="{{ route('about') }}" wire:navigate
                                class="group inline-flex w-full items-center justify-between rounded-full font-semibold whitespace-nowrap text-slate-700 dark:text-slate-200 transition duration-300 ease-out will-change-transform hover:scale-y-102 focus:outline-none focus-visible:ring focus-visible:ring-emerald-500/50 focus-visible:ring-inset h-13 gap-2.5 pr-1.25 pl-5 bg-transparent">
                                <span data-text class="grow">En savoir plus</span>
                                <div data-icon
                                    class="relative isolate grid shrink-0 place-items-center overflow-hidden rounded-full size-11 bg-emerald-600 text-white dark:bg-emerald-500 dark:text-zinc-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.25" viewBox="0 0 28 22"
                                        fill="none">
                                        <path class="fill-current"
                                            d="M1 10H5.96046e-08V12H1V10ZM27 12C27.5523 12 28 11.5523 28 11C28 10.4477 27.5523 10 27 10V12ZM18 1V5.96046e-08H16V1H18ZM26.4207 11.7774C26.9055 12.0419 27.5129 11.8632 27.7774 11.3783C28.0419 10.8935 27.8632 10.286 27.3783 10.0216L26.4207 11.7774ZM15.9999 20.8995V21.8995H17.9999V20.8995H15.9999ZM1 12H26.8994V10H1V12ZM26.8994 12H27V10H26.8994V12ZM16 1C16 2.47241 16.7953 3.87873 17.7716 5.0769C18.7678 6.29956 20.0716 7.44977 21.3383 8.42854C22.6109 9.41186 23.8784 10.2469 24.825 10.835C25.2993 11.1295 25.6952 11.3635 25.9738 11.5245C26.1131 11.605 26.2233 11.6674 26.2993 11.71C26.3374 11.7314 26.3669 11.7478 26.3873 11.7591C26.3975 11.7647 26.4055 11.7691 26.411 11.7721C26.4138 11.7737 26.416 11.7749 26.4176 11.7758C26.4184 11.7762 26.4191 11.7765 26.4196 11.7768C26.4199 11.777 26.4201 11.7771 26.4202 11.7772C26.4205 11.7773 26.4207 11.7774 26.8995 10.8995C27.3783 10.0216 27.3784 10.0217 27.3785 10.0217C27.3785 10.0217 27.3785 10.0217 27.3785 10.0217C27.3784 10.0216 27.3781 10.0215 27.3777 10.0213C27.3769 10.0208 27.3756 10.0201 27.3736 10.019C27.3697 10.0168 27.3634 10.0134 27.3549 10.0087C27.3378 9.99926 27.3118 9.98479 27.2773 9.96547C27.2084 9.92682 27.1058 9.86878 26.9745 9.79288C26.7117 9.64102 26.3342 9.41799 25.8804 9.13606C24.9708 8.57104 23.7635 7.77501 22.5612 6.84596C21.353 5.91235 20.182 4.86894 19.322 3.81356C18.4422 2.73371 18 1.77759 18 1H16ZM26.8994 11C26.5248 10.0728 26.5245 10.0729 26.5242 10.0731C26.524 10.0731 26.5237 10.0733 26.5234 10.0734C26.5228 10.0736 26.522 10.0739 26.5211 10.0743C26.5193 10.0751 26.5169 10.076 26.5138 10.0773C26.5078 10.0797 26.4994 10.0832 26.4888 10.0876C26.4674 10.0964 26.4369 10.1091 26.3979 10.1257C26.3199 10.1587 26.2077 10.2071 26.0662 10.2703C25.7834 10.3967 25.3826 10.5825 24.903 10.824C23.9463 11.3055 22.6639 12.0142 21.3751 12.919C20.0914 13.8201 18.7665 14.94 17.7546 16.2535C16.7415 17.5685 15.9999 19.1342 15.9999 20.8995H17.9999C17.9999 19.715 18.4958 18.5685 19.3389 17.4742C20.1831 16.3784 21.333 15.3922 22.5242 14.5559C23.7103 13.7232 24.9028 13.0632 25.8022 12.6104C26.2507 12.3846 26.6233 12.2119 26.8818 12.0965C27.011 12.0388 27.1115 11.9955 27.1785 11.967C27.212 11.9528 27.2371 11.9424 27.2533 11.9357C27.2613 11.9324 27.2671 11.93 27.2706 11.9286C27.2724 11.9279 27.2735 11.9274 27.2741 11.9271C27.2744 11.927 27.2745 11.927 27.2745 11.927C27.2745 11.927 27.2744 11.927 27.2744 11.927C27.2742 11.9271 27.274 11.9272 26.8994 11Z" />
                    ...
                    {{-- Liens sociaux horizontaux – label + flèche vers le bas (animation conservée) --}}
                            ...
                            <ul x-ref="socialHeader"
                                ...
                                @if ($settings->facebook_url)
                                    <li x-ref="social_1" class="group relative flex flex-col items-center">
                                        <a href="{{ $settings->facebook_url }}" target="_blank" rel="noopener"
                                            class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm text-gray-400 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-lg hover:shadow-blue-600/25 dark:bg-white/5 dark:hover:bg-blue-600"
                                            aria-label="Facebook">
                                ...
                                @if ($settings->instagram_url)
                                    <li x-ref="social_2" class="group relative flex flex-col items-center">
                                        <a href="{{ $settings->instagram_url }}" target="_blank" rel="noopener"
                                            class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm text-gray-400 transition-all duration-300 hover:bg-pink-600 hover:text-white hover:shadow-lg hover:shadow-pink-600/25 dark:bg-white/5 dark:hover:bg-pink-600"
                                ...
                                @if ($settings->x_url)
                                    <li x-ref="social_3" class="group relative flex flex-col items-center">
                                        <a href="{{ $settings->x_url }}" target="_blank" rel="noopener"
                                            class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm text-gray-400 transition-all duration-300 hover:bg-black hover:text-white hover:shadow-lg hover:shadow-black/25 dark:bg-white/5 dark:hover:bg-white dark:hover:text-black"
                                ...
                                @if ($settings->linkedin_url)
                                    <li x-ref="social_4" class="group relative flex flex-col items-center">
                                        <a href="{{ $settings->linkedin_url }}" target="_blank" rel="noopener"
                                            class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm text-gray-400 transition-all duration-300 hover:bg-blue-700 hover:text-white hover:shadow-lg hover:shadow-blue-700/25 dark:bg-white/5 dark:hover:bg-blue-700"
                                            aria-label="LinkedIn">
                                            <svg fill="currentColor" viewBox="0 0 24 24" class="h-5 w-5">
                                                <path
                                ...
                                @if ($settings->youtube_url)
                                    <li x-ref="social_5" class="group relative flex flex-col items-center">
                                        <a href="{{ $settings->youtube_url }}" target="_blank" rel="noopener"
                                            class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm text-gray-400 transition-all duration-300 hover:bg-red-600 hover:text-white hover:shadow-lg hover:shadow-red-600/25 dark:bg-white/5 dark:hover:bg-red-600"
                                            aria-label="YouTube">
                                            <svg fill="currentColor" viewBox="0 0 24 24" class="h-5 w-5">
                                                <path
                                ...
                                <li x-ref="social_6" class="group relative flex flex-col items-center">
                                    <a href="mailto:{{ $settings->email }}"
                                        class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm text-gray-400 transition-all duration-300 hover:bg-red-500 hover:text-white hover:shadow-lg hover:shadow-red-500/25 dark:bg-white/5 dark:hover:bg-red-500"
                                        aria-label="Email">
                                        <svg fill="currentColor" viewBox="0 0 24 24" class="h-5 w-5">
                                            <path
                    ...
                    <div x-ref="decoLine" class="mt-6 h-0.5 w-0 bg-linear-to-r from-emerald-500 to-transparent">
                    </div>
                </div>
            </div>

            <div class="w-full lg:w-1/2 order-1 lg:order-2 flex items-center justify-center lg:justify-end relative">
                {{-- Halo lumineux – s'adapte à la taille de l'image --}}
                <div class="absolute inset-0 bg-emerald-500/10 dark:bg-emerald-400/10 blur-3xl pointer-events-none">
                </div>
                <img x-ref="bgImage" src="{{ $heroImage }}" alt="Portrait de Gauthier Lobanga"
                    class="relative z-10 w-full max-w-lg md:max-w-2xl lg:max-w-full h-auto max-h-[60vh] md:max-h-[80vh] lg:max-h-full object-contain mx-auto lg:mx-0"
    ...
    {{-- ========== Compétences ========== --}}
    @php $skillCount = \App\Models\Skill::count(); @endphp
    @if ($skillCount > 0)
