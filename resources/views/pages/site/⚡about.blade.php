...
use App\Settings\SettingApp;        // ← ajoutez cette ligne
...
new #[Layout('layouts::main')] class extends Component {
    ...
    public function about(): AboutSettings
    {
     ...
     // Nouvelle propriété calculée pour les paramètres généraux
    #[Computed]
                ...
                <div class="w-full max-w-xl">
                    ...
                    <div wire:cloak x-data="{}" class="block">
                        <div x-data="{}" x-init="$nextTick(() => {
                            ...
                            if ($refs.social_6) tl.fromTo($refs.social_5, { autoAlpha: 0, y: -20 }, { autoAlpha: 1, y: 0, duration: 0.6, ease: 'circ.out' }, '>-0.5');
                        })">
