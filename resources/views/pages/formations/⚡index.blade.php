...
<div class="min-h-screen bg-zinc-50 dark:bg-zinc-950">
    ...
    <section class="relative overflow-hidden bg-zinc-50 pt-24 pb-20 sm:pt-32 sm:pb-28 lg:pt-36 lg:pb-32 dark:bg-zinc-950"
        ...
        <div class="pointer-events-none absolute inset-0 z-0 overflow-hidden">
            {{-- Orbes animés --}}
            <div class="absolute -top-[20%] -right-[10%] w-[70%] h-[70%] rounded-full bg-emerald-400/20 mix-blend-multiply blur-[120px] animate-blob dark:bg-emerald-600/20 dark:mix-blend-screen"></div>
            <div class="absolute top-[20%] -left-[10%] w-[60%] h-[60%] rounded-full bg-teal-300/20 mix-blend-multiply blur-[120px] animate-blob animation-delay-2000 dark:bg-teal-500/20 dark:mix-blend-screen"></div>
            <div class="absolute -bottom-[20%] left-[20%] w-[80%] h-[80%] rounded-full bg-cyan-300/20 mix-blend-multiply blur-[120px] animate-blob animation-delay-4000 dark:bg-cyan-600/20 dark:mix-blend-screen"></div>
            ...
            {{-- Grille subtile --}}
            <div class="absolute inset-0 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-size-[24px_24px] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_0%,#000_70%,transparent_100%)]"></div>
        </div>
            ...
            <div class="grid grid-cols-1 items-center gap-16 lg:grid-cols-12 lg:gap-24">
                ...
                <div class="w-full lg:col-span-5 transition-all duration-700 delay-300 ease-[cubic-bezier(0.16,1,0.3,1)]"
                    ...
                    <div
                        ...
                        <div class="absolute inset-0 bg-gradient-to-tr from-white/10 to-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 dark:from-white/5 dark:to-transparent"></div>
                                ...
                                @foreach ($this->stats as $label => $value)
                                    <div x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false"
                                        ...
                                        <div class="relative z-10 flex flex-col items-center gap-1">
                                            <span class="text-4xl sm:text-5xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-zinc-900 to-zinc-600 dark:from-white dark:to-zinc-400 group-hover/stat:from-emerald-600 group-hover/stat:to-teal-500 dark:group-hover/stat:from-emerald-400 dark:group-hover/stat:to-teal-300 transition-all duration-300">
                                                {{ $value }}
                                            </span>
                                            <span class="text-xs font-bold uppercase tracking-wider text-zinc-500 group-hover/stat:text-emerald-700 transition-colors duration-300 dark:text-zinc-400 dark:group-hover/stat:text-emerald-400">
                                                {{ $label }}
                                            </span>
                                        </div>
                                    </div>
    ...
    @island
        <section id="scroll-to-reference" data-preserve-scroll x-data="{ showFilters: false, sortOpen: false }"
            ...
            <div class="mt-5" aria-label="Liste des formations">
                <div wire:transition="cards-grid"
                    ...
                    @forelse ($formations as $formation)
                        <a href="{{ route('formations.show', $formation) }}" wire:navigate
                            class="group relative flex flex-col overflow-hidden rounded-2xl border border-zinc-200/50 bg-white transition-all duration-500 ease-out
                                   hover:-translate-y-2 hover:border-emerald-300 hover:shadow-xl hover:shadow-emerald-100/30
                            ...
                            {{-- Image + badge statut --}}
                            <div
                                class="relative overflow-hidden border-b border-zinc-200 transition duration-500 ease-out group-hover:border-emerald-300 dark:border-zinc-700 dark:group-hover:border-emerald-700">
                            ...
                            <div class="flex flex-1 flex-col gap-2 p-4">
                                ...
                                <div class="mt-3 flex items-center justify-between gap-3">
                                    ...
                                    <time class="text-sm text-zinc-500 dark:text-zinc-400">
                                        {{ $formation->published_at?->translatedFormat('d F Y') ?? $formation->created_at->translatedFormat('d F Y') }}
                                    </time>
                                </div>

                                <div class="flex min-w-0 items-center gap-2">
                                    <img src="{{ $formation->user?->avatar_url ?? asset('images/gaudev-hero.png') }}"
                                        alt="{{ $formation->user?->name ?? 'Gauthier Lobanga' }}"
                                        class="h-8 w-8 rounded-full object-cover" />
                                    <span class="max-w-40 truncate text-sm text-zinc-600 dark:text-zinc-400">
                                        <strong>{{ $formation->user?->name ?? 'Gauthier Lobanga' }}</strong>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="col-span-full py-16 lg:py-24">
                            <div x-data="{ shown: false }" x-intersect="shown = true"
                                ...
                                <div
                                    ...
                                    <h3 class="text-xl font-bold text-zinc-900 dark:text-white">Aucune formation trouvée
                                    </h3>
                                    <p class="mt-2 text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">
                                        Il n'y a pas encore de formation correspondant à cette recherche. Essayez d'ajuster
                                        vos
