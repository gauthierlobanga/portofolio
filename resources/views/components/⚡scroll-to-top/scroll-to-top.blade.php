...
>
    ...
    >
        {{-- Icône --}}
        <span class="relative isolate grid size-9 place-items-center overflow-hidden rounded-full bg-emerald-800 text-white dark:bg-emerald-700">
        ...
        <span class="hidden overflow-hidden whitespace-nowrap text-sm font-medium text-zinc-900 dark:text-zinc-100 sm:block" data-text>
            Retour en haut
        </span>
    </button>
</div>
