<div class="min-h-screen bg-zinc-50 dark:bg-zinc-950">
    <section class="px-5 py-8 xs:px-8 md:p-10 mx-auto max-w-7xl lg:px-12">
                ...
                <a wire:navigate href="{{ route('projects.show', $project) }}"
                    ...
                    <div class="flex h-11 items-stretch text-sm font-medium">
                        <div
                            ...
                            <span
                                class="inline-flex items-center gap-1.5 bg-transparent px-2.5 py-0.5 text-xs font-semibold">Terminé</span>
                        </div>
                        <div
                ...
                <div class="col-span-full py-16 lg:py-24">
                    <div x-data="cspState" x-intersect="shown = true"
                        ...
                        <div
                            ...
                            <h3 class="text-xl font-bold text-zinc-900 dark:text-white">Aucun projet terminé</h3>
                            <p class="mt-2 text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">Revenez bientôt
                                pour découvrir nos réalisations.</p>
                        </div>
                    </div>
                </div>
            @endforelse
        ...
        @if ($this->projects->isNotEmpty())
            <nav class="mt-14 flex justify-center" x-data="buttonTextReveal">
                <a href="{{ route('projects.index') }}" wire:navigate
                    class="group relative inline-flex h-12 items-center justify-center gap-2.5 rounded-full border border-emerald-500/50 bg-transparent px-6 font-semibold text-emerald-600 transition-all duration-300 hover:bg-emerald-600/10 hover:border-emerald-500 active:scale-[0.97] dark:border-emerald-400/40 dark:text-emerald-400 dark:hover:bg-emerald-500/10 dark:hover:border-emerald-400">
                    {{-- Icône dossier --}}
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                    </svg>
                    <span data-text>Voir tous les projets</span>
                    {{-- Flèche animée --}}
